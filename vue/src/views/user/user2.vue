<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading="listLoading"  border fit
      ...
      <el-table-column align="center" label="昵称2" prop="nickname" style="width: 60px;"></el-table-column>
      <el-table-column align="center" label="用户名2" prop="username" style="width: 60px;"></el-table-column>
      <el-table-column align="center" label="角色2" width="200">
        <template slot-scope="scope">
